...
export default function Home() {
      ...
      (entries) => {
        entries.forEach((entry) => {
          if (entry.isIntersecting) {
            entry.target.classList.add("fly-in-from-bottom");
          } else {
            // entry.target.classList.remove("fly-in-from-bottom");
          }
        });
      },
      {
  ...
  return (
    <div className="w-full">
      ...
      <div id="about-us" className="pt-20">
        <div className="w-full min-h-[60vh] sm:pt-10">
          <div className="w-full sm:w-fit sm:flex sm:space-x-10 justify-around items-center max-w-[75rem] mx-auto h-full p-5 sm:p-10">
            <div className="text-center sm:text-right w-full sm:w-1/2 p-5 duration-500 opacity-0 reveal -translate-y-10">
            ...
            <div className="w-full sm:w-1/2  bg-cover h-[20rem] rounded-lg  duration-500 opacity-0 reveal -translate-y-10">
              <Image
                src={"/bg/bg-2.png"}
                alt="bg-2"
                height={1000}
        ...
        <div className="w-full min-h-[60vh]">
          <div className="w-full sm:w-fit sm:flex sm:space-x-10 justify-around items-center max-w-[75rem] mx-auto h-full p-5 sm:p-10">
            <div className="text-center sm:order-2 sm:text-left w-full sm:w-1/2 p-5  duration-500 opacity-0 reveal -translate-y-10">
            ...
            <div className="w-full sm:w-1/2 h-[20rem] rounded-lg  duration-500 opacity-0 reveal -translate-y-10">
              <Image
                src={"/bg/bg-3.jpg"}
                alt="bg-3"
                height={1000}
        ...
        <div className="bg-cyan-800 w-full py-10">
          <Container>
            <div className="py-10">
              <h1 className="text-3xl text-slate-100 mb-5 duration-500 opacity-0 reveal -translate-y-10">
                Our Background
              </h1>
              <p className="text-xl text-slate-100 font-thin mb-10 duration-500 opacity-0 reveal -translate-y-10">
              ...
              <p className="text-2xl text-slate-100 font-thin mb-10 duration-500 opacity-0 reveal -translate-y-10">
      ...
      <div id="gallary" className=" reveal">
        <Container className="pt-10">
          <h1 className="text-3xl text-slate-100 font-[700] mt-10 p-3 bg-blue-700/90 w-fit rounded-xl duration-500 opacity-0 reveal -translate-y-10">
            Meet Our Gallary.
          </h1>
          <div className="grid lg:grid-cols-2 py-10 gap-5">
            {gallary.map((g, i) => (
              <div
                className="w-full relative duration-500 opacity-0 reveal -translate-y-10"
                key={i}
              >
                <Image
                  src={g.image}
                ...
                <div className="w-full group h-full absolute top-0 left-0 bg-transparent group flex justify-center items-center">
                  <h1 className="z-10 opacity-0 group-hover:opacity-100 transition-all duration-500 duration-500 p-5 w-full max-w-[80%] rounded-xl text-slate-100 bg-blue-700/90">
                    {g.description}
                  </h1>
                </div>
              </div>
      ...
      <div id="sponsorship" className="py-20 reveal">
        <Container>
          <h1 className="text-3xl md:text-4xl text-slate-800 font-[700] duration-500 opacity-0 reveal -translate-y-10">
            Sponsorship.
          </h1>
          <div className="w-full py-5 border-b-2 mb-10">
            <p className="text-xl mb-10 duration-500 opacity-0 reveal -translate-y-10">
            ...
            <p className="text-lg mb-5 font-bold duration-500 opacity-0 reveal -translate-y-10">
            ...
            <ol className="flex list-none gap-5 flex-wrap">
              {[
                ...
                <li
                  key={i}
                  className="p-5 text-xl rounded-xl bg-blue-500 text-blue-50 duration-500 opacity-0 reveal -translate-y-10"
                >
                  {i + 1}. {c}
                </li>
              ))}
          ...
          <Link
            href={"/#"}
            className="block duration-500 opacity-0 reveal -translate-y-10 w-full max-w-60 px-5 py-3 text-xl font-[400] text-center rounded-lg bg-gradient-to-r from-pink-500 via-blue-500 to-purple-500 text-slate-100"
          >
            Start Sponsoring
          </Link>
        </Container>
      </div>
      <div id="contact-us" className="py-10 reveal">
        <Container className="bg-sky-800 text-sky-200 p-10 rounded-lg flex flex-col gap-5">
          <h1 className="text-4xl font-[700] duration-500 opacity-0 reveal -translate-y-10">
            Get in touch with us.
          </h1>
          <div className="w-full flex gap-5 flex-col sm:flex-row">
            <div className="w-full duration-500 opacity-0 reveal -translate-y-10">
              <ContactForm />
            </div>
            <div className="w-full flex flex-col justify-center duration-500 opacity-0 reveal -translate-y-10">
              <h1 className="text-3xl">Lumino Town Baptist Church LTD.</h1>
              <p className="text-lg font-thin">P.O.BOX 240244,</p>
              <p className="text-lg font-thin">Busia (U).</p>
              <p className="text-lg font-thin">
                Plot 18 Nahayima Road Busia Municipality.
              </p>
              <h1 className="text-2xl mt-10">
                Email: <span className="font-bold">ltbc1980@gmail.com</span>
              </h1>
